...
<head>
    ...
    <link rel="stylesheet" href="./views/pages/banner/banner-add/banner-add.css">
            ...
            <div class="content">
                ...
                <div class="content-header">
                    <div class="breadcrumb">
                        ...
                        <i class="fas fa-chevron-right breadcrumb-separator"></i>
                        <span class="breadcrumb-current">Thêm mới banner</span>
                    </div>
                    <div class="content-wrapper">
                        <div class="content-text">
                            <h1 class="content-title">Thêm mới banner</h1>
                        </div>
                    </div>
