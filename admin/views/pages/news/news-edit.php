<div class="dashboard">
    <div class="dashboard-header">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-current">Cập nhật tin tức mới</span>
        </div>
        <h1 class="dashboard-title">Trang cập nhật Tin tức</h1>
        <p class="dashboard-description">
            Cập nhật thông tin tin tức tại đây.
        </p>
    </div>
    ...
    <div class="product-form-container">
        <form id="productForm" class="product-form">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-save">Cập nhật tin tức</button>
            </div>
        </form>
    </div>
</div>