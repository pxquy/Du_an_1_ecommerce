...
<head>
    ...
    <link rel="stylesheet" href="./views/pages/slides/slides-list/slides-list.css">
            ...
            <div class="content">
                <div class="content-header">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-current">Quản lý trình chiếu</span>
                    </div>
                    <div class="content-wrapper">
                        <div class="content-text">
                            <h1 class="content-title">Quản lý trình chiếu</h1>
                        </div>
                        <a href="index.php?router=admin/slides/add" class="add-product-btn" id="addProductBtn">
                            <i class="fas fa-plus"></i> Thêm trình chiếu
                        </a>
                    </div>
                ...
                <div class="table-container">
                    <table class="products-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center">Không có trình chiếu nào.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
