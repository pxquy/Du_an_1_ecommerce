...
<head>
    ...
    <link rel="stylesheet" href="./views/pages/slides/slides-edit/slides-edit.css">
            ...
            <div class="content">
                ...
                <div class="content-header">
                    <div class="breadcrumb">
                        ...
                        <i class="fas fa-chevron-right breadcrumb-separator"></i>
                        <span class="breadcrumb-current">Cập nhật trình chiếu</span>
                    </div>
                    <div class="content-wrapper">
                        <div class="content-text">
                            <h1 class="content-title">Cập nhật trình chiếu</h1>
