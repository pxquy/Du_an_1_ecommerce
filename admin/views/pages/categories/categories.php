<div class="dashboard">
    <div class="dashboard-header">
        ...
        <p class="dashboard-description">Danh sách và quản lý danh mục.</p>
    </div>
    ...
    <div class="user-actions">
        ...
        <a href="../category-add/category-add.html" class="add-user-btn">
                ...
                <tr>
                    ...
                    <td>
                        <div class="user-info-cell">
                            ...
                            <div class="user-details">
                                <p class="user-name">Danh mục 1</p>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a
                                href="../category-edit/category-edit.html"
                ...
                <tr>
                    ...
                    <td>
                        <div class="user-info-cell">
                            ...
                            <div class="user-details">
                                <p class="user-name">Danh mục 2</p>
                ...
                <tr>
                    ...
                    <td>
                        <div class="user-info-cell">
                            ...
                            <div class="user-details">
                                <p class="user-name">Danh mục 3</p>
                ...
                <tr>
                    ...
                    <td>
                        <div class="user-info-cell">
                            ...
                            <div class="user-details">
                                <p class="user-name">Danh mục 4</p>
                ...
                <tr>
                    ...
                    <td>
                        <div class="user-info-cell">
                            ...
                            <div class="user-details">
                                <p class="user-name">Danh mục 5</p>
