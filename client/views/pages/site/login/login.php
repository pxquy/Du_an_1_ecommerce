...
<head>
    ...
    <link rel="stylesheet" href="./client/views/pages/site/login/login.css">
        ...
        <div class="login-container">
            <div class="login-wrapper">
                <div class="login-header">
                    ...
                    <p class="login-subtitle">Đăng nhập để trải nghiệm mua sắm tốt hơn</p>
                </div>

                <form action="<?= BASE_URL . '?action=signin' ?>" class="login-form" id="loginForm" novalidate method="POST">
                    ...
                    <button type="submit" class="login-button" name="login-submit">Đăng nhập</button>
            ...
            <div class="login-banner">
                <img src="./assets/images/login-bg.webp" width="500" alt="Arrowwai">
