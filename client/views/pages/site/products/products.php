...
<head>
    ...
    <link rel="stylesheet" href="./client/views/pages/site/products/products.css">
...
<body>
    ...
    <main class="main-content">
        ...
        <section class="container box-welcome">
            <div class="welcome">
                <span><?= $title ?> cao cấp, thiết kế tinh tế và chất lượng vượt trội từ Arrowwai</span>
            </div>
        </section>
        ...
        <div class="reviews-pagination">
            <?php if ($page > 1): ?>
                <a class="pagination-btn prev"
                    href="?action=products&page=<?= $page - 1 ?>">
            ...
            <div class="pagination-numbers">
                <?php if ($totalPages > 1): ?>
                    ...
                    <!-- Trang cuối -->
                    <a href="?action=products&page=<?= $totalPages ?>"
